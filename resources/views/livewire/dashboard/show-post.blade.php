    ...
    <div class="mt-4 transition-all duration-[.25s] sm:mt-5 lg:mt-6">
        ...
        <div class="flex h-8 items-center justify-between">
            <h2 class="text-base font-medium tracking-wide text-slate-700">
                <i class="fa-solid fa-book-open-reader mr-2"></i> {{__('Latest post')}} 
            </h2>
                ...
                @else
                    <div class="flex flex-col">
                        ...
                        <div class="card -mt-8 grow rounded-2xl p-4">
                            ...
                            <div>
                                <a class="text-sm+ font-medium text-slate-700 line-clamp-1 hover:text-primary focus:text-primary">{{__('More post soon')}}</a>
                            </div>
