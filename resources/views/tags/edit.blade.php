          ...
          <div class="card py-5 px-4  sm:px-5">
              <form action="{{route('tags.update', $tag)}}" method="POST">
                  ...
                  <div class="flex mt-10 mb-5">
                    <button class="btn bg-primary font-medium text-white hover:bg-primary-focus hover:shadow-lg hover:shadow-primary/50 focus:bg-primary-focus focus:shadow-lg focus:shadow-primary/50 active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:hover:shadow-accent/50 dark:focus:bg-accent-focus dark:focus:shadow-accent/50 dark:active:bg-accent/90 w-full mx-3" type="submit">
                      <i class="fa-solid fa-rotate mr-2"></i> {{__('update')}}
                    </button>
                    <a href="{{route('tags.index')}}" class="btn bg-slate-800 font-medium text-white hover:bg-slate-800-focus hover:shadow-lg hover:shadow-slate-800/50 focus:bg-slate-800-focus focus:shadow-lg focus:shadow-slate-800/50 active:bg-slate-800-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:hover:shadow-accent/50 dark:focus:bg-accent-focus dark:focus:shadow-accent/50 dark:active:bg-accent/90 w-full mx-3">
