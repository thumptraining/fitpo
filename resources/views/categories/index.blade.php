            ...
            <div class="card mt-3 px-5 pb-10">
              <div class="mx-5 flex">
                ...
                <div class="my-10 object-right">
                  <a href="{{route('categories.create')}}" class="btn size-9 rounded-full bg-info p-0 font-medium text-white hover:bg-info-focus focus:bg-info-focus active:bg-info-focus/90 ml-3">
