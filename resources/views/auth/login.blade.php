    ...
    <main class="flex w-full min-h-screen  flex-col items-center bg-slate-100 dark:bg-navy-700 lg:max-w-md">
        ...
        <div class="flex w-full max-w-sm grow flex-col justify-center p-5">
            ...
            <form class="mt-16" action="{{ route('login') }}" method="POST">
                ...
                <div class="mt-4">
                    <label class="relative flex mb-3">
                        <input class="form-input peer w-full rounded-lg bg-slate-150 px-3 py-2 pl-9 ring-primary/50 placeholder:text-slate-400 hover:bg-slate-800 focus:ring dark:bg-navy-900/90 dark:ring-accent/50 dark:placeholder:text-navy-300 dark:hover:bg-navy-900 dark:focus:bg-navy-900"
                ...
                <div class="mt-4 flex items-center justify-between space-x-2">
                    <label class="inline-flex items-center space-x-2">
                        <input
                            class="form-checkbox is-outline size-5 rounded border-slate-700 bg-slate-100 before:bg-primary checked:border-primary hover:border-primary focus:border-primary checked:bg-slate-800 dark:border-navy-500 dark:bg-navy-900 dark:before:bg-accent dark:checked:border-accent dark:hover:border-accent dark:focus:border-accent"
                            type="checkbox" />
