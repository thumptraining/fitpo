            ...
            <div class="card px-4 pb-4 sm:px-5">
                ...
                <div>
                    ...
                    <div class="inline-space mt-5 flex flex-wrap items-end">
                        ...
                        <button
                            class="btn size-9 border border-primary p-0 font-medium text-primary hover:bg-primary hover:text-white focus:bg-primary focus:text-white active:bg-primary/90"
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                class="size-5"
                        ...
                        <button
                            class="btn size-9 rounded-full bg-slate-150 p-0 font-medium text-slate-800 hover:bg-slate-200 hover:shadow-lg hover:shadow-slate-200/50 focus:bg-slate-200 focus:shadow-lg focus:shadow-slate-200/50 active:bg-slate-200/80"
                        >
                            <i class="fa-solid fa-house-chimney"></i>
                        </button>
                        <button
                            class="btn mask is-hexagon size-9 bg-primary p-0 font-medium text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90"
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                class="size-5"
