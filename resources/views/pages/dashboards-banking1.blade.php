                        ...
                        <div class="flex items-center justify-between py-3">
                            ...
                            <div x-data="usePopper({ placement: 'bottom-end', offset: 4 })" @click.outside="if(isShowPopper) isShowPopper = false"
                                ...
                                <button x-ref="popperRef" @click="isShowPopper = !isShowPopper"
                                    class="btn -mr-1 size-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25">
            ...
            <div class="col-span-12 lg:col-span-8">
                <div class="grid grid-cols-2 gap-4 sm:grid-cols-4 sm:gap-5 lg:gap-6">
                    <div class="card p-4 sm:p-5">
                        <div
                            class="flex size-12 items-center justify-center rounded-xl bg-primary shadow-xl shadow-primary/50">
