                  ...
                  >
                    <div class="flex items-start p-4">
                      <div class="avatar size-10">
                        ...
                        />
                        <div
                          class="absolute right-0 size-3 rounded-full border-2 border-navy-600 bg-primary"
                        ></div>
                      </div>
                    </div>
                    <div class="p-2">
