            ...
            <div class="space-y-4 sm:space-y-5 lg:space-y-6">
                ...
                <div class="card items-center p-4 sm:p-5 lg:p-7">
                    ...
                    <div class="mt-6 grid grid-cols-3 gap-4">
                        <button
                            class="btn size-9 rounded-full p-0 text-slate-700 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25">
                    ...
                    <div x-data="accordionItem('item-1')">
                        ...
                        <div x-show="expanded" x-collapse>
                            <div class="flex justify-between pt-4">
                                ...
                                <button
                                    class="btn size-7 rounded-full bg-secondary/10 p-0 text-secondary hover:bg-secondary/20 focus:bg-secondary/20 active:bg-secondary/25">
                                ...
                                <button
                                    class="btn size-7 rounded-full bg-slate-150 p-0 text-slate-800 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200/80">
                ...
                <div class="card p-4 sm:p-5">
                    ...
                    <div class="mt-6 flex items-center justify-between">
                        <div class="space-x-1.5">
                            <button
                                class="btn size-8 rounded-full bg-slate-150 p-0 font-medium text-slate-800 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200/80">
