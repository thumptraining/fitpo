    ...
    <main class="main-content w-full px-[var(--margin-x)] pb-8">
      ...
      >
        ...
        <div class="fixed left-0 top-0 z-[101] h-full w-72">
          <div
            class="flex h-full w-full transform-gpu flex-col bg-white transition-transform duration-200"
            x-show="showDrawer"
            x-transition:enter="ease-out"
            ...
            <div class="flex space-x-5 px-5">
              ...
              <div class="mt-2 w-full">
                <div class="flex justify-between space-x-3">
                  <h4
                    class="text-base font-medium text-slate-700 line-clamp-1"
                  >
                    John Doe
                  </h4>
                  <div
                  ...
                  >
                    <button
                      ...
                      class="btn -mr-1.5 size-6 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        class="size-4"
                ...
                <a
                  href="#"
                  class="cursor-pointer text-xs+ text-primary hover:text-primary-focus"
                  >@johndoe</a
                >
              </div>
            </div>
            ...
            <ul class="grow space-y-1.5 px-5 font-inter font-medium">
              ...
              <li>
                ...
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="size-5 text-slate-400 transition-colors group-hover:text-primary group-focus:text-primary"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
