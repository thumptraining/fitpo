                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div class="-mr-1.5 flex">
                                <button x-tooltip.secondary="'Like'"
                                    class="btn size-7 rounded-full p-0 text-secondary-light hover:bg-secondary/20 focus:bg-secondary/20 active:bg-secondary/25">
                                ...
                                <button x-tooltip="'Save'"
                                    class="btn size-7 rounded-full p-0 text-navy-100 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="size-4.5" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                        <path stroke-linecap="round" stroke-linejoin="round"
