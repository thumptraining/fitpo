        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 lg:grid-cols-3 lg:gap-6 xl:grid-cols-4">
            <div class="card grow items-center p-4 sm:p-5">
                ...
                <div class="grow space-y-4">
                    <div class="flex items-center space-x-4">
                        <div
                            class="flex size-7 items-center rounded-lg bg-primary/10 p-2 text-primary">
            ...
            <div class="card grow items-center p-4 sm:p-5">
                <div class="avatar size-20">
                    <img class="rounded-full " src="{{asset('images/200x200.png')}}" alt="avatar" />
                    <div
                        class="absolute right-0 m-1 size-4 rounded-full border-2 border-white bg-slate-300">
                    </div>
                </div>
                <h3 class="pt-3 text-lg font-medium text-slate-700">
                    Travis Fuller
