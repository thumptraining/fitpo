            ...
            <div class="card p-4 sm:col-span-2 sm:p-5">
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 lg:gap-6">
                    <div
                        ...
                        <div
                            class="mask is-star-2 flex size-12 items-center justify-center bg-warning/10">
                            <svg xmlns="http://www.w3.org/2000/svg" class="size-6 text-warning"
                    ...
                    <div
                        class="flex items-center space-x-4 rounded-2xl border border-slate-150 p-4">
                        <div
                            class="mask is-star-2 flex size-12 items-center justify-center bg-primary/10">
                            <svg xmlns="http://www.w3.org/2000/svg" class="size-6 text-primary"
                                fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div
                        class="flex items-center space-x-4 rounded-2xl border border-slate-150 p-4">
                        <div
                            class="mask is-star-2 flex size-12 items-center justify-center bg-secondary/10">
                            <svg xmlns="http://www.w3.org/2000/svg" class="size-6 text-secondary"
                                fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div
                        class="flex items-center space-x-4 rounded-2xl border border-slate-150 p-4">
                        <div
                            class="mask is-star-2 flex size-12 items-center justify-center bg-success/10">
                            <svg xmlns="http://www.w3.org/2000/svg" class="size-6 text-success"
                                fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
