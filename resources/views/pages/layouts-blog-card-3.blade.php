                    ...
                    <div class="flex items-center justify-between">
                        <div class="-ml-1.5 flex">
                            <button x-tooltip.secondary="'12k Like'"
                                class="btn size-9 rounded-full p-0 hover:bg-slate-300/20 hover:text-secondary focus:bg-slate-300/20 focus:text-secondary active:bg-slate-300/25">
                            ...
                            <button x-tooltip.success="'5k Commnets'"
                                class="btn size-9 rounded-full p-0 hover:bg-slate-300/20 hover:text-success focus:bg-slate-300/20 focus:text-success active:bg-slate-300/25">
                                <svg xmlns="http://www.w3.org/2000/svg" class="size-5.5" fill="none"
                            ...
                            <button x-tooltip.info="'Share'"
                                class="btn size-9 rounded-full p-0 hover:bg-slate-300/20 hover:text-info focus:bg-slate-300/20 focus:text-info active:bg-slate-300/25">
                                <svg xmlns="http://www.w3.org/2000/svg" class="size-5" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="mt-3 flex items-center justify-between space-x-3">
                    ...
                    <div class="relative flex w-full">
                        ...
                        <div class="absolute right-0 z-10 flex size-8 items-center justify-center">
                            <button
                                class="btn size-6 rounded-full p-0 hover:bg-slate-300/20 hover:text-primary focus:bg-slate-300/20 focus:text-primary active:bg-slate-300/25">
