                ...
                <div class="flex justify-between px-4 py-4">
                    ...
                    <div class="-mr-1.5 flex">
                        <button x-tooltip.secondary="'Like'"
                            class="btn size-7 rounded-full p-0 text-secondary hover:bg-secondary/20 focus:bg-secondary/20 active:bg-secondary/25">
                ...
                <div class="border-t border-slate-200 px-2 py-1.5">
                    <div class="relative flex w-full">
                        ...
                        <div class="absolute right-0 z-10 flex size-8 items-center justify-center">
                            <button
                                class="btn size-7 rounded-full p-0 hover:bg-slate-300/20 hover:text-primary focus:bg-slate-300/20 focus:text-primary active:bg-slate-300/25">
