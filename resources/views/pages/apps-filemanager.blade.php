<x-base-layout title="File Manager" is-sidebar-open="true" is-header-blur="true" has-min-sidebar="true">
                                ...
                                <ul class="mt-1 space-y-1 px-2 font-inter text-xs+ font-medium">
                                    <li x-data="{ expanded: false }">
                                        <div tabindex="0"
                                            ...
                                            <button @click="expanded = !expanded"
                                                class="btn mr-1 size-5 rounded-lg p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25">
        ...
        <div
            ...
            <div class="flex">
                ...
                <a href="{{ route('layouts/help-1') }}"
                    class="btn size-8 rounded-full p-0 text-slate-500 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25">
                    <svg xmlns="http://www.w3.org/2000/svg" class="size-5" fill="none" viewBox="0 0 24 24"
                        ...
                        <div class="card swiper-slide w-56 shrink-0 p-3 pt-4">
                            <div class="flex items-center justify-between">
                                <img class="w-14" src="{{ asset('images/folders/folder-primary.svg') }}"
                                    alt="folder" />
                                <button
                                    class="btn -mr-2 size-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25">
                ...
                <div class="card mt-3 space-y-3.5 p-4 text-xs+">
                    <div class="group flex items-center justify-between">
                        <div class="flex space-x-3">
                            <div
                                class="flex size-10 items-center justify-center rounded-full bg-primary text-white">
                        ...
                        <button
                            class="btn -mr-2 size-8 rounded-full p-0 opacity-0 hover:bg-slate-300/20 focus:bg-slate-300/20 focus:opacity-100 active:bg-slate-300/25 group-hover:opacity-100">
                            <svg xmlns="http://www.w3.org/2000/svg" class="size-5" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M12 5v.01M12 12v.01M12 19v.01M12 6a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z" />
    ...
    <div class="fixed right-3 bottom-3 rounded-full bg-white">
        <button
            class="btn size-14 rounded-full bg-primary p-0 font-medium text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 sm:hidden">
