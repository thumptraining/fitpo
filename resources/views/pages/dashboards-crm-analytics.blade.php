                    ...
                    <div class="mt-4 flex shrink-0 flex-col items-center sm:items-start">
                        ...
                        <button
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="size-4.5 text-slate-400" fill="none" viewBox="0 0 24 24"
                            ...
                            <tr>
                                <td class="whitespace-nowrap py-2">
                                    <div class="flex items-center space-x-2">
                                        <div
                                            class="size-3.5 rounded-full border-2 border-primary">
                                        </div>
                    ...
                    <div class="flex items-center justify-between space-x-2">
                        ...
                        <div class="flex space-x-2">
                            <div class="relative cursor-pointer">
                                <button
                                    class="btn size-7 bg-primary/10 p-0 text-primary hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25">
