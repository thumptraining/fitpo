                ...
                <div class="flex h-[calc(100%-4.5rem)] grow flex-col">
                    <div class="is-scrollbar-hidden flex grow flex-col overflow-y-auto">
                        ...
                        <ul class="space-y-1">
                            <li>
                                <a href="#"
                                    class="btn relative size-10 p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25">
                                    <div
    ...
    <main class="main-content kanban-app w-full">
        <div
            ...
            <div class="flex space-x-1">
                ...
                <div class="flex">
                    <button
                        class="btn size-6 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 sm:hidden sm:h-8 sm:w-8">
                    ...
                    <button
                        class="btn size-6 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 sm:h-8 sm:w-8">
                        <svg xmlns="http://www.w3.org/2000/svg" class="size-4 sm:h-5 sm:w-5" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                            <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <button x-data="{ isImportant: true }" @click="isImportant =! isImportant"
                        class="btn hidden size-6 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 sm:inline-flex sm:h-8 sm:w-8">
                        ...
                        <svg x-show="isImportant" xmlns="http://www.w3.org/2000/svg"
                            class="size-5.5 text-primary" viewBox="0 0 20 20"
                            fill="currentColor">
                            <path
            ...
            <div x-init="Sortable.create($el, {
                            ...
                            <div class="px-2.5 pb-2 pt-1.5">
                                <div>
                                    <div class="flex justify-between">
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            class="-mr-1.5 size-3.5 shrink-0 text-secondary"
                ...
                <div class="board-draggable relative flex max-h-full w-72 shrink-0 flex-col">
                    <div class="board-draggable-handler flex items-center justify-between px-0.5 pb-3">
                        <div class="flex items-center space-x-2">
                            <div
                                class="flex size-8 items-center justify-center rounded-lg bg-secondary/10 text-secondary">
                                <svg xmlns="http://www.w3.org/2000/svg" class="size-5" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                            ...
                            <ul class="mt-2 space-y-3 px-4 font-inter font-medium">
                                <li>
                                    <a class="group inline-flex items-center space-x-2 tracking-wide outline-none transition-colors hover:text-slate-800 focus:text-navy-800"
                                        href="#">
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            class="size-5 text-slate-400 transition-colors group-hover:text-slate-500 group-focus:text-slate-500"
                                            fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                stroke-width="1.5"
