<x-app-layout title="Price List 3" is-header-blur="true">
    <main class="main-content w-full place-items-center px-[var(--margin-x)] pb-12">
        ...
        <div class="mx-auto w-full grid max-w-5xl grid-cols-1 gap-4 sm:grid-cols-3 md:gap-5 2xl:gap-6">
            <div class="card">
                <div class="rounded-t-lg bg-slate-150 p-4 text-center sm:p-5">
                ...
                <div class="p-4 sm:p-5">
                    ...
                    <div class="mt-8">
                        <button
                            class="btn w-full bg-slate-150 font-medium h-10 text-slate-800 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200/80">
                            Choose Plan
                        </button>
                    </div>
                </div>
            ...
            <div class="card">
                <div class="rounded-t-lg bg-primary p-4 text-center sm:p-5">
                ...
                <div class="p-4 sm:p-5">
                    ...
                    <div class="mt-8">
                        <button
                            class="btn w-full h-10 bg-primary font-medium text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90">
                            Choose Plan
                        </button>
                    </div>
                </div>
