                ...
                <div class="flex h-[calc(100%-4.5rem)] grow flex-col">
                    ...
                    <div class="py-3">
                        <div x-data="usePopper({ placement: 'right-start', offset: 4 })" @click.outside="if(isShowPopper) isShowPopper = false"
                            class="inline-flex">
                            <button x-ref="popperRef" @click="isShowPopper = !isShowPopper"
                                class="btn size-10 rounded-full border border-slate-300 p-0 font-medium hover:bg-slate-150 focus:bg-slate-150 active:bg-slate-150/80">
                ...
                <div class="flex items-center space-x-2">
                    ...
                    <div class="flex">
                        <button @click="isSearchbarActive = true" x-tooltip="'Search'"
                            class="btn size-9 p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 sm:hidden">
                            <svg xmlns="http://www.w3.org/2000/svg" class="size-5" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                        ...
                        <button x-tooltip="'Filter'"
                            class="btn size-9 p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25">
                            <svg xmlns="http://www.w3.org/2000/svg" class="size-5" fill="none"
            ...
            <div x-show="isSearchbarActive">
                <div class="flex space-x-2">
                    ...
                    <button @click="isSearchbarActive = false" x-tooltip="'Search'"
                        class="btn size-9 shrink-0 p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 sm:hidden">
