            ...
            <div class="space-y-4 sm:space-y-5 lg:space-y-6">
                ...
                <div class="card p-4">
                    <div class="flex -space-x-px">
                        ...
                        <button
                            class="btn z-2 size-10 shrink-0 rounded-l-none bg-primary p-0 font-medium text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90">
            ...
            <div class="space-y-4 sm:space-y-5 lg:space-y-6">
                ...
                <div class="card space-y-4 p-4 sm:p-5">
                    <div class="flex items-center space-x-4">
                        <div class="size-5 rounded border-2 bg-transparent"></div>
                        <p>Not Color</p>
                    </div>
                    <div class="flex items-center space-x-4">
                        <div class="size-5 rounded border-2 border-primary bg-transparent"></div>
                        <p>Primary Color</p>
                    </div>
                    <div class="flex items-center space-x-4">
                        <div
                            class="size-5 rounded border-2 border-secondary bg-transparent">
                        </div>
                        <p>Secondary Color</p>
                    </div>
                    <div class="flex items-center space-x-4">
                ...
                <div class="card px-4 pb-5 sm:px-5">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center space-x-3">
                            <div
                                class="mask is-squircle flex size-10 items-center justify-center bg-primary/10">
