                            ...
                            <div class="flex space-x-4 font-inter text-slate-700"
                                ...
                                <div x-data="usePopper({ placement: 'bottom-end', offset: 4 })" @click.outside="if(isShowPopper) isShowPopper = false"
                                    ...
                                    <button x-ref="popperRef" @click="isShowPopper = !isShowPopper"
                                        class="btn size-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 sm:-mr-1.5">
                        ...
                        <div class="rounded-lg border border-slate-150 p-3">
                            <div class="flex justify-between space-x-1">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    class="size-5 shrink-0 text-primary" fill="none"
                    ...
                    <div class="card px-4 pb-4 sm:px-5">
                        ...
                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            ...
                            <div
                                ...
                                <div class="flex items-center space-x-3">
                                    <div
                                        class="flex size-10 shrink-0 items-center justify-center rounded-lg bg-slate-300 text-slate-700">
                ...
                <div class="card mt-4 px-4 pb-4 sm:mt-5 sm:px-5 lg:mt-6">
                    ...
                    <div class="relative">
                        ...
                        <div class="absolute right-0 top-1/2 mt-1">
                            <button
                                class="btn mask is-hexagon size-7 bg-primary p-0 font-medium text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90">
